...
public class Lab5Main {
	...
	public static void main(String[] args) {
		...
		while (menuChoice.charAt(0) != '7') {
			...
			System.out.println ("5 to delete bad blocks in the chain: ");
			...
			case '4': if (myBlockChain.verifyChain())
	          		  ...
	          		  break;
			case '5': 
						if (myBlockChain.removeBadBlock() != null)
							System.out.println ("broken block is removed successfuly");
						else
							System.out.println ("broken block is failed to remove");
					  break;
